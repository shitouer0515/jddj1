...
function jddj(){
    ...
    # clone
    rm -rf /scripts/jddj && git clone -b main https://github.com/shitouer0515/jddj.git /scripts/jddj
    # 下载自定义cookie文件地址,如私密的gist地址,需修改
    jddj_cookiefile="https://raw.githubusercontent.com/shitouer0515/jddj/main/jddj_cookie.js"
